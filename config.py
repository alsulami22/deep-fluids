...
net_arg.add_argument('--res_y', type=int, default=48)
...
data_arg.add_argument('--dataset', type=str, default='liquid3_d5_r10_f150')
...
train_arg.add_argument('--start_step', type=int, default=196172)
